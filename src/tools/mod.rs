...
use crate::core::permissions::{PermissionDecision, PermissionHandler, PermissionRequest};
...
pub struct PendingPermissionRequest {
    ...
    pub request: crate::core::permissions::PermissionRequest,
    pub reason: String,
...
pub struct ToolContext {
    ...
    pub managed_agent_config: Option<crate::core::config::ManagedAgentConfig>,
    ...
    pub permission_manager: Option<Arc<std::sync::Mutex<crate::core::permissions::PermissionManager>>>,
...
impl ToolContext {
    ...
    fn request_permission_inner(
    ...
    ) -> Result<(), crate::core::error::ClaudeError> {
        ...
        match decision {
            ...
            PermissionDecision::Ask { reason } if self.non_interactive => Err(
                crate::core::error::ClaudeError::PermissionDenied(format!(
            ...
            PermissionDecision::Ask { reason } => {
                let Some(queue) = &self.pending_permissions else {
                    return Err(crate::core::error::ClaudeError::PermissionDenied(format!(
                        "Permission denied for tool '{}'",
                        request.tool_name
                    )));
                };
                ...
                match decision {
                    ...
                    _ => Err(crate::core::error::ClaudeError::PermissionDenied(
                        "Permission denied by user".to_string(),
                    )),
                }
            }
            _ => Err(crate::core::error::ClaudeError::PermissionDenied(format!(
                "Permission denied for tool '{}'",
                request.tool_name
            ))),
        }
...
pub trait Tool: Send + Sync {
    /// Human-readable name (matches the constant in crate::core::constants).
    fn name(&self) -> &str;
...
mod tests {
    ...
    impl crate::core::permissions::PermissionHandler for AskPermissionHandler {
        fn check_permission(
            &self,
            _request: &crate::core::permissions::PermissionRequest,
        ) -> crate::core::permissions::PermissionDecision {
        ...
        fn request_permission(
            &self,
            request: &crate::core::permissions::PermissionRequest,
        ) -> crate::core::permissions::PermissionDecision {
    ...
    fn test_tool_context(
        handler: Arc<dyn crate::core::permissions::PermissionHandler>,
    ) -> ToolContext {
