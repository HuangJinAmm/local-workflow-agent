...
mod tests {
    ...
    fn build_client_info_sets_expected_protocol_and_identity() {
        ...
        assert_eq!(info.client_info.name, crate::core::constants::APP_NAME);
        assert_eq!(info.client_info.version, crate::core::constants::APP_VERSION);
        assert_eq!(
            info.capabilities
                .roots
                .as_ref()
