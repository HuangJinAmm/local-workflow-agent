...
use crate::core::constants::{ANTHROPIC_API_VERSION, ANTHROPIC_BETA_HEADER};
use crate::core::error::ClaudeError;
use crate::core::types::{ContentBlock, Message, MessageContent, Role, ToolDefinition, UsageInfo};
...
pub mod client {
    ...
    impl Default for ClientConfig {
        fn default() -> Self {
            Self {
                api_key: String::new(),
                api_base: crate::core::constants::ANTHROPIC_API_BASE.to_string(),
    ...
    impl AnthropicClient {
        ...
        pub fn from_config(cfg: &crate::core::config::Config) -> anyhow::Result<Self> {
            let api_key = cfg
                .resolve_api_key()
        ...
        async fn send_with_retry(
            ...
            let (account_uuid, has_premium): (String, bool) = if use_oauth {
                ...
                CACHE
                    .get_or_init(crate::core::oauth::current_anthropic_account_meta)
                    .await
                    .clone()
                    .unwrap_or_default()
            } else {
