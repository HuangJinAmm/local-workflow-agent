//! Theme registry — loads the bundled `themes/*.json` sets and applies the
//! active `ThemeMode` (Light / Dark) onto the global `gpui_component::Theme`.
//!
//! Ported verbatim from `chat-ai/src/theme.rs`.
