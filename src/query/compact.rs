...
fn estimate_block_chars(block: &ContentBlock) -> usize {
    match block {
        ...
        ContentBlock::ToolResult { content, .. } => match content {
            crate::core::types::ToolResultContent::Text(t) => t.len(),
            crate::core::types::ToolResultContent::Blocks(blocks) => {
                ...
                match block {
                    ...
                    ContentBlock::ToolResult { tool_use_id, content, is_error } => {
                        let result_text = match content {
                            crate::core::types::ToolResultContent::Text(t) => t.as_str().to_string(),
                            crate::core::types::ToolResultContent::Blocks(_) => "[complex content]".to_string(),
                        };
...
pub fn snip_compact(messages: Vec<crate::core::types::Message>, keep_n_newest: usize) -> (Vec<crate::core::types::Message>, u64) {
    let total = messages.len();
...
pub fn calculate_messages_to_keep_index(messages: &[crate::core::types::Message], token_budget: u64) -> usize {
...
/// `reactiveCompact.ts`.
fn strip_images(messages: Vec<crate::core::types::Message>) -> Vec<crate::core::types::Message> {
...
pub async fn reactive_compact(
    ...
    if cancel.is_cancelled() {
        return Err(crate::core::error::ClaudeError::Cancelled);
    }
    ...
    for path in recently_modified.iter().take(MAX_FILES * 3) {
        ...
        new_messages.push(crate::core::types::Message::user(text));
        injected += 1;
    }
...
pub async fn context_collapse(
    ...
    for msg in &messages {
        let role = match msg.role {
            crate::core::types::Role::User => "Human",
    ...
    if summary_text.is_empty() {
        return Err(crate::core::error::ClaudeError::Other(
            "Context-collapse summary was empty".to_string(),
        ));
    }

    // Keep only: the synthetic summary + the most recent user turn.
    let collapse_notice = crate::core::types::Message::user(format!(
...
pub fn collapse_read_tool_results(messages: Vec<crate::core::types::Message>) -> Vec<crate::core::types::Message> {
    use crate::core::types::{ContentBlock, MessageContent, ToolResultContent};
...
pub fn collapse_search_results(messages: Vec<crate::core::types::Message>) -> Vec<crate::core::types::Message> {
    use crate::core::types::{ContentBlock, MessageContent, ToolResultContent};
    ...
    let mut result: Vec<crate::core::types::Message> = messages
        .into_iter()
        .rev()
        .map(|mut msg| {
            if let MessageContent::Blocks(ref mut blocks) = msg.content {
