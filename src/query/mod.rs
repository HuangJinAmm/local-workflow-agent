...
pub struct QueryConfig {
    ...
    pub output_style: crate::core::system_prompt::OutputStyle,
    ...
    /// level specifies one.
    pub effort_level: Option<crate::core::effort::EffortLevel>,
    ...
    pub provider_registry: Option<std::sync::Arc<crate::api::ProviderRegistry>>,
    /// Active agent name (e.g., "build", "plan", "explore", or None for default).
    pub agent_name: Option<String>,
    /// Resolved agent definition for the current session.
    pub agent_definition: Option<crate::core::AgentDefinition>,
    ...
    pub model_registry: Option<std::sync::Arc<crate::api::ModelRegistry>>,
    /// Managed agent (manager-executor) configuration.
    pub managed_agents: Option<crate::core::ManagedAgentConfig>,
}

impl Default for QueryConfig {
    fn default() -> Self {
        Self {
            model: crate::core::constants::DEFAULT_MODEL.to_string(),
            max_tokens: crate::core::constants::DEFAULT_MAX_TOKENS,
            max_turns: crate::core::constants::MAX_TURNS_DEFAULT,
            system_prompt: None,
            append_system_prompt: None,
            output_style: crate::core::system_prompt::OutputStyle::Default,
...
impl QueryConfig {
    ...
    pub fn from_config_with_registry(cfg: &Config, registry: &crate::api::ModelRegistry) -> Self {
        // We can't move the Arc here, but we need a clone for the query loop.
        // Callers typically wrap the registry in an Arc already.
        Self {
            model: crate::api::effective_model_for_config(cfg, registry),
            max_tokens: cfg.effective_max_tokens(),
            output_style: cfg.effective_output_style(),
            output_style_prompt: cfg.resolve_output_style_prompt(),
            working_directory: cfg
...
fn reasoning_effort_for_level(
    effort_level: crate::core::effort::EffortLevel,
) -> &'static str {
    match effort_level {
        crate::core::effort::EffortLevel::Low => "low",
        crate::core::effort::EffortLevel::Medium => "medium",
        crate::core::effort::EffortLevel::High | crate::core::effort::EffortLevel::Max => {
            "high"
        }
    }
}
...
fn google_thinking_level_for_effort(
    effort_level: Option<crate::core::effort::EffortLevel>,
) -> &'static str {
    match effort_level.unwrap_or(crate::core::effort::EffortLevel::High) {
        crate::core::effort::EffortLevel::Low => "low",
        crate::core::effort::EffortLevel::Medium => "medium",
        crate::core::effort::EffortLevel::High | crate::core::effort::EffortLevel::Max => {
            "high"
    ...
    if is_openaiish_provider(provider_id) && is_openai_reasoning_model(&model_id) {
            ...
            && provider_id != "azure"
        {
            ...
            if provider_id == "deepseek" {
                match effort_level {
                    None
                    | Some(crate::core::effort::EffortLevel::Medium)
                    | Some(crate::core::effort::EffortLevel::High) => {
                        options.insert(
                            "thinking".to_string(),
                    ...
                    Some(crate::core::effort::EffortLevel::Max) => {
                        options.insert(
                            "thinking".to_string(),
                            serde_json::json!({"type": "enabled"}),
                        );
                    ...
                    Some(crate::core::effort::EffortLevel::Low) => {
                        options.insert(
                            "thinking".to_string(),
...
pub struct PostSamplingHookResult {
    ...
    pub blocking_errors: Vec<crate::core::types::Message>,
...
pub fn fire_post_sampling_hooks(
    _turn_result: &crate::core::types::Message,
    config: &crate::core::config::Config,
) -> PostSamplingHookResult {
    use crate::core::config::HookEvent;
...
pub fn stop_hooks_with_full_behavior(
    turn_result: &crate::core::types::Message,
    config: &crate::core::config::Config,
...
fn total_tool_result_chars(messages: &[Message]) -> usize {
    messages
        ...
        .flat_map(|m| match &m.content {
            crate::core::types::MessageContent::Blocks(blocks) => blocks.as_slice(),
            _ => &[],
        })
        .filter_map(|b| {
...
fn apply_tool_result_budget(messages: Vec<Message>, budget: usize) -> (Vec<Message>, usize) {
    ...
    'outer: for msg in result.iter_mut() {
        if msg.role != crate::core::types::Role::User {
            continue;
        }
        let blocks = match &mut msg.content {
            crate::core::types::MessageContent::Blocks(b) => b,
            _ => continue,
        };
...
// Spinner verbs are imported from crate::core::spinner
...
pub async fn run_query_loop(
    ...
    loop {
        ...
        let handler: Arc<dyn StreamHandler> = if let Some(ref tx) = event_tx {
            ...
            Arc::new(crate::api::streaming::NullStreamHandler)
        };
        ...
        if let Some(ref registry) = config.provider_registry {
            let (provider_id_str, model_id_str) = if let Some(p) = tool_ctx.config.provider.as_deref().filter(|p| *p != "anthropic") {
                ...
                let temp_reg;
                let model_reg: &crate::api::ModelRegistry = if let Some(ref shared) = config.model_registry {
                    shared
                } else {
                    temp_reg = {
                        let mut r = crate::api::ModelRegistry::new();
            ...
            if use_provider_dispatch {
                let pid = crate::core::provider_id::ProviderId::new(&provider_id_str);
                ...
                let runtime_provider =
                    crate::api::registry::runtime_provider_for(&provider_id_str);
                ...
                if let Some(_) = crate::api::registry::resolve_provider_api_base(
                    &tool_ctx.config,
                    &provider_id_str,
                ) {
                    if let Some(overridden) = crate::api::registry::provider_from_config(
                        &tool_ctx.config,
                        &provider_id_str,
                    ) {
                ...
                if let Some(provider) = provider {
                    ...
                    let provider_tools: Vec<crate::core::types::ToolDefinition> = if caps.tool_calling {
                        tools.iter().map(|t| t.to_definition()).collect()
                    } else {
                        Vec::new()
                    };
                    let provider_messages: Vec<crate::core::types::Message> = messages
                        .iter()
                        .map(|msg| {
                            let mut msg = msg.clone();
                            if let crate::core::types::MessageContent::Blocks(ref mut blocks) = msg.content {
                                for block in blocks.iter_mut() {
                                    match block {
                                        crate::core::types::ContentBlock::Image { .. } if !caps.image_input => {
                                            *block = crate::core::types::ContentBlock::Text {
                                                text: "[Image not supported by this model]".to_string(),
                                            };
                                        }
                                        crate::core::types::ContentBlock::Document { .. } if !caps.pdf_input => {
                                            *block = crate::core::types::ContentBlock::Text {
                    ...
                    let provider_request = crate::api::ProviderRequest {
                        ...
                        thinking: if caps.thinking {
                            effective_thinking_budget
                                .map(|b| crate::api::ThinkingConfig::enabled(b))
                        } else {
                            None
                        },
                    ...
                    let mut stream = match provider.create_message_stream(provider_request).await {
                        ...
                        Err(e) => {
                            ...
                            return QueryOutcome::Error(
                                crate::core::error::ClaudeError::Api(e.to_string())
                            );
                        }
                    };
                            ...
                            event = stream.next() => {
                                ...
                                match event {
                                    ...
                                    Some(Ok(evt)) => {
                                        ...
                                        match &evt {
                                            crate::api::StreamEvent::MessageStart { id, usage: u, .. } => {
                                                msg_id = id.clone();
                                                usage.input_tokens = u.input_tokens;
                                                usage.cache_read_input_tokens = u.cache_read_input_tokens;
                                                usage.cache_creation_input_tokens = u.cache_creation_input_tokens;
                                            }
                                            crate::api::StreamEvent::ContentBlockStart { index, content_block } => {
                                                if let ContentBlock::ToolUse { id, name, .. } = content_block {
                                                    tool_call_blocks.insert(*index, (id.clone(), name.clone(), String::new()));
                                                }
                                            }
                                            crate::api::StreamEvent::TextDelta { text, .. } => {
                                                text_chunks.push(text.clone());
                                            }
                                            crate::api::StreamEvent::ThinkingDelta { thinking, .. } => {
                                                thinking_chunks.push(thinking.clone());
                                            }
                                            crate::api::StreamEvent::ReasoningDelta { reasoning, .. } => {
                                                thinking_chunks.push(reasoning.clone());
                                            }
                                            crate::api::StreamEvent::InputJsonDelta { index, partial_json } => {
                                                if let Some((_, _, buf)) = tool_call_blocks.get_mut(index) {
                                                    buf.push_str(partial_json);
                                                }
                                            }
                                            crate::api::StreamEvent::MessageDelta { stop_reason, usage: u } => {
                                                stop_str = match stop_reason {
                                                    Some(crate::api::provider_types::StopReason::ToolUse) => "tool_use".to_string(),
                                                    Some(crate::api::provider_types::StopReason::MaxTokens) => "max_tokens".to_string(),
                                                    Some(crate::api::provider_types::StopReason::StopSequence) => "stop_sequence".to_string(),
                                                    Some(crate::api::provider_types::StopReason::ContentFiltered) => "content_filtered".to_string(),
                                                    Some(crate::api::provider_types::StopReason::EndTurn) => "end_turn".to_string(),
                                                    Some(crate::api::provider_types::StopReason::Other(s)) => s.clone(),
                                            ...
                                            crate::api::StreamEvent::MessageStop => break,
                                            _ => {}
                                        }
                                    }
                                }
                    ...
                    let mut assistant_msg = Message {
                        ...
                        content: crate::core::types::MessageContent::Blocks(content_blocks.clone()),
                        uuid: Some(msg_id),
                        cost: None,
                        snapshot_patch: None,
                    };
                    ...
                    if !tool_use_blocks.is_empty() {
                        ...
                        for (tool_id, tool_name, tool_input) in tool_use_blocks {
                            ...
                            tool_results.push(ContentBlock::ToolResult {
                                tool_use_id: tool_id,
                                content: crate::core::types::ToolResultContent::Text(result.content),
                                is_error: Some(result.is_error),
                            });
                        }
                        messages.push(Message {
                            role: crate::core::types::Role::User,
                            content: crate::core::types::MessageContent::Blocks(tool_results),
                            uuid: None,
                            cost: None,
                            snapshot_patch: None,
                        });
                        ...
                        if let Some(ref tx) = event_tx {
                            let _ = tx.send(QueryEvent::Stream(
                                AnthropicStreamEvent::ContentBlockDelta {
                                    index: 0,
                                    delta: crate::api::streaming::ContentDelta::TextDelta { text: placeholder.clone() },
                                },
                            ));
                        }
                        if let crate::core::types::MessageContent::Blocks(ref mut blocks) =
        ...
        macro_rules! fire_stop_hook {
            ($msg:expr) => {{
                let stop_ctx = crate::core::hooks::HookContext {
                ...
                crate::core::hooks::run_hooks(
                    ...
                    crate::core::config::HookEvent::Stop,
                    &stop_ctx,
            ...
            "end_turn" => {
                ...
                if session_memory::SessionMemoryExtractor::should_extract(messages) {
                    ...
                    if let Ok(api_key) = std::env::var("ANTHROPIC_API_KEY") {
                        if !api_key.is_empty() {
                            if let Ok(sm_client) = crate::api::AnthropicClient::new(
            ...
            "tool_use" => {
                ...
                for block in tool_blocks {
                    if let ContentBlock::ToolUse { id, name, input } = block {
                        ...
                        let hook_ctx = crate::core::hooks::HookContext {
                        ...
                        let pre_outcome = crate::core::hooks::run_hooks(
                            hooks,
                            crate::core::config::HookEvent::PreToolUse,
                            &hook_ctx,
                            &tool_ctx.working_dir,
                        )
                        .await;
                ...
                for (p, result) in prepared.iter().zip(exec_results.into_iter()) {
                    let hooks = &tool_ctx.config.hooks;
                    let post_ctx = crate::core::hooks::HookContext {
                    ...
                    crate::core::hooks::run_hooks(
                        hooks,
                        crate::core::config::HookEvent::PostToolUse,
                        &post_ctx,
                        &tool_ctx.working_dir,
                    )
                    .await;
...
fn build_todo_nudge(session_id: &str) -> String {
    let todos = crate::tools::todo_write::load_todos(session_id);
...
///
/// Delegates to `crate::core::system_prompt::build_system_prompt` so that all
...
fn build_system_prompt(config: &QueryConfig) -> SystemPrompt {
    use crate::core::system_prompt::SystemPromptOptions;
    ...
    let text = crate::core::system_prompt::build_system_prompt(&opts);
...
fn map_to_anthropic_event(
    evt: &crate::api::StreamEvent,
) -> Option<crate::api::AnthropicStreamEvent> {
    ...
    match evt {
        ...
        StreamEvent::MessageDelta { stop_reason, usage } => {
            ...
            let stop_reason_str = stop_reason.as_ref().map(|r| match r {
                crate::api::provider_types::StopReason::ToolUse => "tool_use".to_string(),
                crate::api::provider_types::StopReason::MaxTokens => "max_tokens".to_string(),
                crate::api::provider_types::StopReason::StopSequence => "stop_sequence".to_string(),
                crate::api::provider_types::StopReason::EndTurn => "end_turn".to_string(),
                crate::api::provider_types::StopReason::ContentFiltered => "content_filtered".to_string(),
                crate::api::provider_types::StopReason::Other(s) => s.clone(),
            });
...
mod tests {
    ...
    fn test_system_prompt_default_when_empty() {
        ...
        if let SystemPrompt::Text(text) = prompt {
            ...
            assert!(
                text.contains(crate::core::system_prompt::SYSTEM_PROMPT_DYNAMIC_BOUNDARY),
    ...
    fn test_system_prompt_with_append() {
        ...
        if let SystemPrompt::Text(text) = prompt {
            ...
            let boundary_pos = text
                .find(crate::core::system_prompt::SYSTEM_PROMPT_DYNAMIC_BOUNDARY)
    ...
    fn test_query_outcome_debug() {
        ...
        let err_outcome = QueryOutcome::Error(crate::core::error::ClaudeError::RateLimit);
...
pub async fn run_single_query(
    ...
    let handler: Arc<dyn StreamHandler> = Arc::new(crate::api::streaming::NullStreamHandler);
